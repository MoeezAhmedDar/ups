            ...
            <div class="card-body">
                ...
                <table class="table" id="my-table">
                    ...
                    // {
                        ...
                        ?>
                        <thead>
                            <th colspan="9" style="text-align: right">Remaining Balance:</th>
                            <th colspan="2" style="text-align: right">{{ $data[$i - 1]['total_amount'] }}</th>
                        </thead>
                    </tbody>
                </table>
...
<script>
    ...
    // setTimeout(function(){window.location.href="{{ route('view_ledger_customer',$id) }}";},1000);
});
